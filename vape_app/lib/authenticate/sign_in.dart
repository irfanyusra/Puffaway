...
class _SignInState extends State<SignIn> {
  final AuthService _auth =
      AuthService(); //Private variable calls functions from AuthService()
  final _formKey =
      GlobalKey<FormState>(); //Used to identify the forms and hence validate it
                        ...
                        children: <Widget>[
                          ...
                          TextFormField(
                            ...
                            validator: EmailFieldValidator
                                .validate, //val.isEmpty?'Enter an email':null
                            onChanged: (val) {
